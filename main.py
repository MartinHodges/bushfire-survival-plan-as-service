...
async_redis_client = redis.Redis(host=redis_service, port=6379, password=redis_password, decode_responses=True, db=0)
...
queue_manager = RedisQueueManager(async_redis_client)
