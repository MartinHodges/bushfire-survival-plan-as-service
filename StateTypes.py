...
class Choice(BaseModel):
    choice_prompt: str = Field(description="The prompt to ask the user to make a choice", default="")
...
class GraphState(BaseModel):
    ...
    continue_with_plan: Choice = Field(description="A choice for the user to stop or continue with plannning.", default_factory=Choice) 
    defence_assessment: Optional[DefenceAnalysis] = None
    stay_or_leave_plan: Choice = Field(description="A choice for the user to create a leave early or stay and defend plan.", default_factory=Choice) 
