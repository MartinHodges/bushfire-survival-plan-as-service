...
plan_prompt = PromptTemplate(
    template="""
Situation
You are an authoritive expert bushfire safety consultant tasked with creating the final deliverable 
...
and actionable bushfire survival plan document in HTML format that follows strict 
...
Ensure all section headings use proper HTML formatting.
...
class ShowPlan:
  ...
  def __call__(self, state: GraphState):
    ...
    # Split the HTML into lines for display
